...
const COORD = {
  ...
  postalY:     53.0,  // 〒郵便番号 top（58→53.0 合計-5.0mm上げ: 初回-3.5+追加-1.5 2026-07-17）
  addr1Y:      56.0,  // 住所1行目 top（61→56.0 -5.0mm）
  addr2Y:      59.0,  // 住所2行目 top（64→59.0 -5.0mm）
  companyX:    137,   // 会社名・代表者名の左端X
  repNameX:    141,   // 代表者名のみ左端X
  companyW:    75,    // 幅
  companyY:    62.15, // 会社名 top（67.15→62.15 -5.0mm）
  repNameY:    70.0,  // 代表者名 top（75→70.0 -5.0mm）

  // 角印 (sealDataUrl) ※他様式(112px≒30mm)に合わせてサイズUP。中心維持のためX/Yを-4mm補正
  kakuinY:    47.0,   // 角印 top（52→47.0 合計-5.0mm上げ 2026-07-17）
  kakuinX:    142,
  kakuinSize: 30,

  // 丸印・代表印 (repSealDataUrl) ※他様式(96px≒25mm)に合わせてサイズUP。中心維持のためX/Yを-1.5mm補正
  maruinY:    60.5,   // 丸印 top（65.5→60.5 合計-5.0mm上げ 2026-07-17）
