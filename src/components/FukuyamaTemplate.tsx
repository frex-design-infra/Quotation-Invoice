...
const COORD = {
  ...
  deliveryYearX:      55.0, // 納品日 年（50→52.5→55.0 右計+5.0mm 2026-07-17）
  deliveryMoX:        79.0, // 納品日 月（72→…→77.0→79.0 月のみ+2mm 2026-07-17）
  deliveryDayX:       97.0, // 納品日 日（92→…→97.0 右計+5.0mm）
  deliveryPersonY:    156.0, // 納品担当者 top（150→…→156.0 下計+6.0mm 2026-07-17）
  deliveryPersonX:    160.0, // 納品担当者 左端X（155→157.5→160.0 右計+5.0mm 2026-07-17）
